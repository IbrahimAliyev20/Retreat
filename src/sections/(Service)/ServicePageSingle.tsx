...
export default function ServicePageSingle({ service }: ServicePageSingleProps) {
  return (
    <div>
      <section
        className="relative min-h-[700px] bg-cover bg-center text-white"
        style={{ backgroundImage: `url(${service.image})`, backgroundPosition: "center", backgroundSize: "cover" }}
      >
        <div className="absolute inset-0 bg-black/40"></div>

        <div className="container flex flex-col items-start justify-center min-h-[700px] px-20 relative z-10">
      ...
      <section className="container mx-auto flex flex-col md:flex-row items-start justify-between py-30 min-h-screen">
        <div className="w-[69%] pr-0 md:pr-15">
