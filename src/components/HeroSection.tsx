    ...
    <div className="bg-cream min-h-screen flex items-center justify-center">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between ">
        <div className="w-full md:w-1/2 text-center md:text-left pr-4">
          <h1
            className="text-5xl md:text-8xl font-serif text-brown leading-tight mb-6 opacity-0"
            ref={titleRef}
          >
            Yoga and
            <br />
          ...
          <p
            className="text-lg text-brown mb-8 opacity-0"
            ref={textRef}
          >
          ...
          <button
            className="bg-[#493913] text-white py-3 px-6 rounded-full hover:bg-opacity-90 transition opacity-0"
            ref={buttonRef}
          >
            See schedule
          </button>
        ...
        <div className="w-full md:w-1/2 relative mt-10 md:mt-0 pl-0 md:pl-34">
          <div className="relative w-full max-w-lg opacity-0" ref={mainImageRef}>
            <Image
            ...
            />
            <div className="absolute -bottom-12 -left-12 w-70 opacity-0" ref={secondaryImageRef}>
              <Image
